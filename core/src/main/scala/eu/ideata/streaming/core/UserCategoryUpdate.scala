...
case class UserInfoWithCategory(userId: String, category: String, timestamp: Long, booleanFlag: Boolean, subCategory: String, someValue: Float, intValue: Int, updated: Long)